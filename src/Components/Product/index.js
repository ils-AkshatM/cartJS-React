        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex justify-between items-center mt-10">
              ...
              <div className="flex">
                <button className="flex ml-auto text-white bg-blue-500 border-0 py-2 px-6 mr-2 focus:outline-none hover:bg-blue-600 rounded">
                  Buy Now
                </button>
                <button className="flex ml-auto border border-blue-500 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded hover:text-white">
                  Add to Cart
                </button>
              </div>
